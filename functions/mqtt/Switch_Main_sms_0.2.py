...
CONST_SMS_MAX_SEND_VALUE = 5 #문자를 최대 5번 전송한다.

# Alarm발생시간 및 경과시간
CONST_ALARM_ELASPED_TIME = 1 #1시간경과 후에 다시 SMS발송한다.
...
def smsSend(message,parm_gpio_value,parm_flag_value):
    ...
    #현재시간보다 CONST_ALARM_ELASPED_TIME시간전 시간을 구한다.
    alarm_elapsed_time = datetime.datetime.now() - datetime.timedelta(hours=CONST_ALARM_ELASPED_TIME)
