...
CONST_SMS_MAX_SEND_VALUE = 2 #문자를 최대 2번 전송한다.

# Alarm발생시간 및 경과시간
CONST_ALARM_ELASPED_TIME = 5 #5분경과 후에 다시 SMS발송한다.
...
def smsSend(message,parm_gpio_value,parm_flag_value):
    ...
    #현재시간보다 CONST_ALARM_ELASPED_TIME시간(분단위) 시간을 구한다.
...
#============================================================= zone1 close       
        if GPIO.input(GPIO_IN_SECURITY) == 0 and flag_Security == 0:            
            ...
            MESSAGE_SECURITY_SETUP = "화재감지기가 복구되었습니다!!"
...
#============================================================zone1 open           
            ...
            pubMessage.pub_MQTT(str(),str(),alarmMessage)
            MESSAGE_SECURITY_INTRUSION = "화재감지기가 작동하였습니다!!"
#========================================================= zone2 close           
